...
export const ROUTE_FEATURE_MAP: Record<string, string> = {
    ...
    '/metrics-dashboard/executive-view': 'metrics.view',
    '/metrics-dashboard/delivery-view': 'metrics.view',
    '/metrics-dashboard/transformation-progress': 'metrics.view',
    '/metrics-dashboard/productivity-flow': 'metrics.view',
    '/metrics-dashboard/adoption-fluency': 'metrics.view',
    '/metrics-dashboard/assets-reuse': 'metrics.view',
    '/metrics-dashboard/tokens-cost': 'metrics.view',
    '/metrics-dashboard/agent-performance': 'metrics.view',
    '/reports': 'reports.view',
    '/integrations': 'admin.integrations',
    '/import': 'admin.import',
    '/audit': 'admin.audit_logs',
    '/admin': 'admin.console',
    '/admin/organizations': 'admin.console',
    '/admin/markets': 'admin.console',
    '/admin/accounts': 'admin.console',
    '/admin/projects': 'admin.console',
    '/admin/teams': 'admin.console',
    '/admin/members': 'admin.console',
    '/admin/users': 'admin.console',
    '/admin/onboard-employee': 'admin.console',
    '/admin/report-schedules': 'admin.console',
